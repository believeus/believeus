...
public class SogouLibAnalyse {

     /***/
	public static void analyse(String srcName,String dicName) throws Exception {
		String projectdir=System.getProperty("user.dir"); 
		File file = new File(projectdir+"/src/main/resources/dicsrc/"+srcName);
		...
		System.setOut(new PrintStream(new File(projectdir+"/src/main/resources/dicdata/"+dicName)));
