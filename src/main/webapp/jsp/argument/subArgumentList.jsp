...
<c:forEach items="${subArgumentList }" var="argument" varStatus="s">
    ...
    <div>
	  <div style="position:absolute; left:${260+((s.index mod 3)*280)}px;top: ${top*350+70 }px;">
		...
		<div style="top:-245px; position: relative; left: 50px; "><a href="/argumentDetail-bid-${argument.id}.html" style="color: red;"> <html:html value="${argument.title }" num="8"/></a></div>
