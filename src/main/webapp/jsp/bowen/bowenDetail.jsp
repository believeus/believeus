...
<%@ taglib uri="http://www.believeus.cn/jstl/html" prefix="date"%>
<%@ taglib uri="http://www.believeus.cn/jstl/date" prefix="html" %>
<head>
...
<body>
		...
		<div class="w-95p  p-10 m-auto lh-30 m-t-10">
			<ul>
				  <li><b>中医博文模块</b></li>
				  <li><b>编辑时间</b> <date:date value="${bowen.editDate }" parttern="yyyy-MM-dd HH:mm:ss E"/></li>
				  <li><b>发布人</b>${bowen.author }</li>
				  <li><b>博文标题</b>
				  		${bowen.title}
				  </li>
				  ...
				  <div style="width:80%; height:auto; clear:both; background:#f5f5f5; border:3px solid #CCC;padding:20px; overflow:hidden">					  	
						<p><html:html num="${fn:length(bowen.content) }" value="${bowen.content }"/></p>
				  </div>
				  </li>	
			</ul>
		</div>		
