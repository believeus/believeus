...
<c:forEach items="${yaoShanList }" var="yaoShan" varStatus="s">
...
<!-- End Name:wuqiwei Date:2013-08-14 AddReason:该逻辑是用来对内容框的每行三列的显示 -->
    <div>
	  <div style="position:absolute; left:${260+((s.index mod 3)*280)}px;top: ${top*350+70 }px;">
		...
		<div style="top:-245px; position: relative; left: 50px; "><a href="/yaoShanDetail-id-${yaoShan.id}.jhtml" style="color: red;"><html:html value="${yaoShan.title}" num="8"/></a></div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			if(count>countPerPage){
				var believeusPagiation=new BelieveusPagiation('Searchresult','/subYaoShanAjaxList',countPerPage,count,"jhtml");
