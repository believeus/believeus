...
<body>
		...
		<div class="w-95p  p-10 m-auto lh-30 m-t-10">
			<ul>
				  <li><b>中医医案模块</b></li>
				  <li><b>编辑时间</b> <date:date value="${cases.editDate }" parttern="yyyy-MM-dd HH:mm:ss E"/></li>
				  <li><b>发布人</b>${cases.author }</li>
				  <li><b>博文标题</b>
				  		${cases.title}
				  </li>
				  <li><b>医案内容</b>	<span style="position: relative;left: 550px;"><a href="javascript:history.go(-1);" style="color: green; font-size: 15px;">返回</a></span>
				  <div style="width:80%; height:auto; clear:both; background:#f5f5f5; border:3px solid #CCC;padding:20px; overflow:hidden">					  	
						<p><html:html num="${fn:length(cases.content) }" value="${cases.content}"/></p>
				  </div>
				  </li>	
			</ul>
		</div>		
