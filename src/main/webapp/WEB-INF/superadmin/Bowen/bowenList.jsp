...
<body>
		...
		<tr>
			<td colspan="10" style="text-align:left; text-indent:1em">
				<form id="alertform" name="alertform" method="post" action="">
					<font style="color: green; font-size: 20px;">博文信息搜索：</font> 标题:<span>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			var count="${bowenCount}";
			var countPerPage=5;
			if(count>countPerPage){
				var believeusPagiation=new BelieveusPagiation('Searchresult','/adminBowenList',countPerPage,count,"html");
