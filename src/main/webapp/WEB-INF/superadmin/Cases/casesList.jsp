...
<body>
	...
	<div class="org_header xiangdui">
		  ...
		  <div class="usr_info r">
		  	你好： <a href="#">${sessionAdmin.adminName}</a> | 
		  	<a href="/adminLogout.html">赶紧退出</a>
		  </div>
	</div>
	<div class="clear"></div>
		...
		<tr>
			<td colspan="10" style="text-align:left; text-indent:1em">
				<form id="alertform" name="alertform" method="post" action="">
					<font style="color: green; font-size: 20px;">医案信息搜索：</font> 标题:<span>
	...
	<!-- 分页的显示区 -->
	 	<table class="tableborder" border="0" id="tbody">
			...
			<a href="/adminNewCasesView.jhtml"><font style="font-size: 15px;">新建医案</font></a>
				<span class="r">搜索结果：<b></b>个
			</span> <span><a href="">全部医案信息</a><b>${casesCount}</b>个 <a href="">封禁</a><b>2000</b>个
			</span></td>
		</tr>
		<tr>
			<th>医案编号</th>
			...
			<c:forEach items="${casesliList}" var="cases" varStatus="status">
			<!-- Begin Name:wuqiwei Date 2013-4-17 21:10:13 addReason:奇偶行变色 -->
				...
				<tr id="_Item_Index_1" align="left" style="max-height: 50px; background-color: ${backgroundColor}">
					...
					<td style="max-width: 100px; text-align:left; max-height: 50px;">
						<a href="/adminBowenDetail-Jid-${cases.id}.html" >
	...
	<script type="text/javascript">
		$(document).ready(function(){
			var count="${casesCount}";
			var countPerPage=5;
			if(count>countPerPage){
				var believeusPagiation=new BelieveusPagiation('Searchresult','/adminSubCasesAjaxList',countPerPage,count,"jhtml");
