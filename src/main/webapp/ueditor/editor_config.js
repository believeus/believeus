...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/upload.do?act=upload"             //图片上传提交地址
       //imagepath 表示的是文件的保存路径。
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:URL+"/upload.do?act=scrawlUp"           //涂鸦上传地址
        ,scrawlPath:""                            					//图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:"/upload.do?act=upload"               //附件上传提交地址
        ,filePath:""                   							//附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:"/upload.do?act=getRemoteImage"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/upload.do?act=imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:""                                 //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: "/upload.do?act=upload" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: ""
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:"/upload.do?act=upload"            //word转存提交地址
        ,wordImagePath:""					                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:"/upload.do?act=getMovie"            //视频数据获取地址
...
//        ,initialContent:'留下点什么吧!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子

        ,initialFrameWidth:962 //初始化编辑器宽度,1000，同时支持百分比，例如："70%"
